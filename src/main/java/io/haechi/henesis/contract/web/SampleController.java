...
public class SampleController {
    ...
    public CommonResult requestMasterWalletContractCallWithHenesisAPI(
        ...
        String msg = "Master wallet contract call API";
        return this.responseBuilder.getSuccessResult(msg);
    }
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public CommonResult requestUserWalletContractCallWithHenesisAPI(
            @PathVariable String blockchainSymbol,
            @PathVariable String masterWalletId,
        ...
        String msg = "User wallet contract call API";
        return this.responseBuilder.getSuccessResult(msg);
    }
}
