...
public class SampleController {
    ...
    @ApiOperation(value = "ERC20 Trasfer API", notes = "마스터 지갑에서 ERC20 컨트랙트 함수를 호출하는 트랜잭션을 발생시킵니다.")
    @PostMapping(value = "/{blockchainSymbol}/{masterWalletId}/contract-call")
    @ResponseStatus(value = HttpStatus.OK)
    public ContractJsonObject trasfer(
            @PathVariable Blockchain blockchainSymbol,
        ...
        return this.contractCallService.contractCall(blockchainSymbol, masterWalletId, contractCallRequestBody);
    }
}
